...
export function  radian2angle(value: number): number {
    return value / Math.PI * 180;
}

export function  angle2radian(value: number): number {
    return value / 180 * Math.PI;
}
export function  makeImage(): any {
...
/**阿拉伯数字转换成中文数字 */
export function  getChiNum($id: number): string {
    return keyChi[$id];
}
export function  hexToArgb(expColor: number, is32: boolean = true, color: Vector3D = null):  Vector3D {
    if (!color) {
        color = new  Vector3D();
    }
...
export function  hexToArgbNum(expColor: number, is32: boolean = true, color: Vector3D = null):  Vector3D {
...
/**描边路径 */
export function  strokeFilter(ctx: CanvasRenderingContext2D, width: number, height: number, color: number): void {
...
export function  TweenMoveTo(taget: any, t: number, vars: any): void {
  
}


export function  getScencdStr(timeNum: number): string {
...
export function  randomByItem(arr: Array<any>): any {
    return arr[random(arr.length)]
}
export function  makeArray(a: Array<any>, b: Array<any>): void {
    if (!a) {
        //console.log("有错")
    }
...
export function  unZip($aryBuf: ArrayBuffer): ArrayBuffer {
...
export function  getZipByte($byte: Pan3dByteArray):  Pan3dByteArray {
...
export function  copy2clipboard(val: string): void {
...
export function  getBit($num: number, offset: number): boolean {
