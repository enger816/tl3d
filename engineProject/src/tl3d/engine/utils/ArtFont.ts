...
namespace tl3d {
    export class ArtFont {
        ...
        static BOSSBIGTXT: string = "NUM99";
        static CN1: string = "NUM100";
        static num101: string = "NUM101";
        static num102: string = "NUM102";

        static BigYellow: string = "NUM12";
        static num99: string = "NUM99";
        static GARY_TXT: string = "NUM1";  //NUM1.PNG
        static ORANGE_TXT: string = "NUM19";  //NUM2


        static num1: string = "NUM1";  //NUM1
        static num2: string = "NUM2";  //NUM2
        static num3: string = "NUM3";  //NUM3
        static num4: string = "NUM4";  //NUM4
        static num5: string = "NUM5";  //NUM5
        static num6: string = "NUM6";  //NUM6
        static num7: string = "NUM7";  //NUM7

        static num10: string = "NUM10";  //NUM10

        static num8: string = "NUM8";  //NUM8
        static num9: string = "NUM9";  //NUM9
        static num11: string = "NUM11";  //NUM11

        static num12: string = "NUM12";  //NUM

        static num13: string = "NUM13";  //NUM13
        static num14: string = "NUM14";  //NUM
        static num15: string = "NUM15";  //NUM


        static num16: string = "NUM16";  //NUM
        static num17: string = "NUM17";  //NUM
        static num18: string = "NUM18";  //NUM
        static num19: string = "NUM19";  //NUM
        static num20: string = "NUM20";  //NUM
        static num21: string = "NUM21";  //NUM

        static num22: string = "NUM22";  //NUM
        static num23: string = "NUM23";  //NUM

        static num24: string = "NUM24";  //NUM
        static num25: string = "NUM24";  //NUM
        static num26: string = "NUM26";  //NUM
        static num27: string = "NUM27";  //NUM
        static num28: string = "NUM28";  //NUM

        static num30: string = "NUM30";  //NUM


        static num51: string = "NUM51";  //NUM
        static num52: string = "NUM52";  //NUM
        static num53: string = "NUM53";  //NUM
        static num54: string = "NUM54";  //NUM
        static num55: string = "NUM55";  //NUM
        static num56: string = "NUM56";  //NUM
        static num57: string = "NUM57";  //NUM
        static num58: string = "NUM58";  //NUM
        static num59: string = "NUM59";  //NUM
        static num60: string = "NUM60";  //NUM

        static num61: string = "NUM61";  //NUM
        static numVip: string = "NUM62";  //NUM
        static num63: string = "NUM63";  //NUM
        static num64: string = "NUM64";  //NUM
        static num65: string = "NUM65";  //NUM
        static num66: string = "NUM66";  //NUM

        //英雄召唤新增
        static num76: string = "NUM76";  //NUM
        static num77: string = "NUM77";  //NUM
        static num81: string = "NUM81";  //NUM
         ...
         * @param txtInterval 
         */
        public writeFontToCtxCenten($ctx: CanvasRenderingContext2D, $str: string, pw: number, $color: string = ArtFont.White, $tx: number = 0, $ty: number = 0, $txtInterval: number = 0): number {
            var $textItem: Array<Rectangle> = this.fontData[$color]
            var totalW: number = 0;
            var $txtWidth: number = this.getAirFontWidth($ctx, $str, $color, $txtInterval);
            //居中位置
            ...
            for (var i: number = 0; i < $str.length; i++) {
                numId = this.getCharId($str[i]);
                var txtNumRect: Rectangle = this.getRect(numId, $color, $textItem);
                $ctx.drawImage(UIData.textImg, txtNumRect.x, txtNumRect.y, txtNumRect.width, txtNumRect.height, totalW + startX, $ty, txtNumRect.width, txtNumRect.height);
                totalW = totalW + (txtNumRect.width - $txtInterval);
            }
            return $txtWidth;
        }
