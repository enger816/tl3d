...
import { IndexFormat } from "../../../l3d/IndexFormat";
import { VertexBuffer3D } from "../../../l3d/VertexBuffer3D";
import { BufferState } from "../../../l3d/BufferState";
    ...
    export class ObjData extends ResCount {
        ...
        /** laya buffer */
        public layaVertexBuffer:VertexBuffer3D;

        /** laya buffer */
        public layaIndexBuffer:IndexBuffer3D;

        public indexFormat: IndexFormat = IndexFormat.UInt16;

        public _bufferState: BufferState = new BufferState;
