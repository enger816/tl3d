...
import {BindParticle} from "../base/MeshData"
...
import {GroupItem} from "../utils/res/GroupRes"
...
import {DualQuatFloat32Array} from "../vo/skinanim/AnimData"
        ...
        public addSkinMeshParticle(): void {
            ...
            for (var i: number = 0; i < meshAry.length; i++) {
                ...
                for (var j: number = 0; j < particleAry.length; j++) {
                    ...
                    var particle: CombineParticle = ParticleManager.getInstance().getParticleByte(Scene_data.fileRoot + bindPartcle.url);
