...
(function (helpinfo) {
    ...
    var HelpInfoPanel = /** @class */ (function (_super) {
        ...
        function HelpInfoPanel() {
            ...
            _this._midRender.setInfo("ui/help/help.txt", "ui/help/help.png", function () { _this.loadConfigCom(); });
            return _this;
        }
        ...
        HelpInfoPanel.prototype.loadConfigCom = function () {
            ...
            this.addChild(this._midRender.getComponent("c_win_bg"));
            this.c_head_pic = this.addChild(this._topRender.getComponent("c_head_pic"));
            this.c_help_user_name = this.addChild(this._topRender.getComponent("c_help_user_name"));
            this.addChild(this._topRender.getComponent("c_help_text_info"));
            this.c_back_an = this.addEvntBut("c_back_an", this._topRender);
        ...
        HelpInfoPanel.prototype.refrishData = function (value) {
            ...
            if (this.uiLoadComplte && this.infoData) {
                ...
                var $url = "res/d.jpg";
                LabelTextFont.writeSingleLabel(this._topRender.uiAtlas, this.c_help_user_name.skinName, $arr[0], 20, TextAlign.CENTER, Pan3d.ColorType.Black000000);
                if ($arr[1].length > 10) {
                    $url = $arr[1];
                }
                Pan3d.LoadManager.getInstance().load($url, Pan3d.LoadManager.IMG_TYPE, function ($img) {
                    var rec = _this._topRender.uiAtlas.getRec(_this.c_head_pic.skinName);
