namespace tl3d {
    export class MainUiLoad {
        ...
        static init($res: Array<any>, $bfun: Function, $loadFun: Function = null): number {
    ...
    export class UIData {
        //设计宽高
        static designWidth: number = 960;
        static designHeight: number = 540;
        static font: string = "Helvetica";//Georgia
        ...
        static get mainUIAtlas(): UIAtlas {//基础公用显示对象。如提示框。还有公用背景按钮
            return null
        ...
        static publicUi: string = "publicUi";
        static flytext: string = "flytext";
        static publicsUi: string = "publicsUi";
        static faceItem: Array<string> = ["/大笑", "/脸2", "/脸3", "/脸4", "/脸5", "/脸6", "/脸7", "/脸8", "/脸9", "/脸a", "/脸b", "/脸c", "/脸d", "/脸e", "/脸f", "/脸g", "/脸h", "/脸i"];
    ...
    export class UiDraw {
        ...
        /**属性 - value */
        static drawAttVal($ui: UICompenent, $att: number, $val: number, $align: string = TextAlign.LEFT, $needadd: boolean = false): void {
            var keyStr: string = "";
            ...
            keyStr = ColorType.Orange7a2f21 + UnitFunction.getKeyProById($att) + ":  " + ColorType.Orange9a683f + UnitFunction.Snum(Math.floor($val / 100));
            if ($needadd) {
                keyStr = ColorType.Orange7a2f21 + UnitFunction.getKeyProById($att) + ":  " + ColorType.Orange9a683f + "+" + UnitFunction.Snum(Math.floor($val / 100));
            }
        ...
        static drawAttValAdd($ui: UICompenent, $att: number, $val: number): void {
            ...
            keyStr = ColorType.Orange7a2f21 + UnitFunction.getKeyProById($att) + ":    " + ColorType.Green2ca937 + "+" + UnitFunction.Snum(Math.floor($val / 100));
        ...
        //将目标的图绘制到CXT对象中，
        static cxtDrawImg($cxt: CanvasRenderingContext2D, $name, $rect: Rectangle, $key: string): void {
         ...
         */
        static SharedDrawImg($touiAtlas: UIAtlas, $fromuiAtlas: UIAtlas, $skinName: string, $shareName: string, $tx: number = 0, $ty: number = 0, $fillflag: boolean = true): void {
        ...
        static RepeatLoadImg($url1: string, $url2: string, $backFuc: Function = null): void {
