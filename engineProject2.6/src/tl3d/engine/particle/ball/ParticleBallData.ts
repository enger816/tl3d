...
import { Display3DBallShader } from "./Display3DBallShader";
import { Scene_data } from "../../context/Scene_data";
import { Vector3D } from "../../math/Vector3D";
import { ColorTransition } from "../../utils/ColorTransition";
...
import { Display3DBallPartilce } from "./Display3DBallPartilce";
...
export class ParticleBallData extends ParticleData {
    ...
    public initBaseColor(): void {
        ...
        for (var i: number = 0; i < this._totalNum; i++) {
            var index: number = Util.float2int(128 * Math.random()) * 4;
    ...
    private compressVertex(): void {
        ...
        var size: number = objBallData.vertices.length / 3;
        ...
        var indexBuffer: IndexBuffer3D = new IndexBuffer3D(objBallData.indexFormat, indices.length, WebGLRenderingContext.STATIC_DRAW, false);
    ...
    public regShader(): void {
        ...
        this.materialParam.shader = ProgramManager.getInstance().getMaterialProgram(Display3DBallShader.Display3D_Ball_Shader,
