...
import { LQuaternion as  Quaternion } from "../math/LQuaternion";
...
export class ShaderData {
	/**@internal */
	private _ownerResource: Laya.Resource = null;
	/**@internal */
	 ...
	 * @internal
	 */
	constructor(ownerResource: Laya.Resource = null) {
	...
	setTexture(index: number, value: Laya.BaseTexture): void {
		var lastValue: Laya.BaseTexture = this._data[index];
		this._data[index] = value;
	 ...
	 *@internal [NATIVE]
	 */
	getTextureForNative(index: number): Laya.BaseTexture {//[NATIVE]
		return this._nativeArray[index];
	}
	 ...
	 *@internal [NATIVE]
	 */
	setTextureForNative(index: number, value: Laya.BaseTexture): void {//[NATIVE]
		if (!value) return;
		this.needRenewArrayBufferForNative(index);
		var lastValue: Laya.BaseTexture = this._nativeArray[index];
		this._nativeArray[index] = value;//保存引用
	...
	clearRuntimeCopyArray(): void {
		var currentFrame: number = Laya.Stat.loopCount;
