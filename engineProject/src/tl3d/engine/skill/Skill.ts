namespace tl3d {
    export class Skill extends ResCount {
        ...
        public actionCompleteFun: Function;
        public time: number = 0;
        static MaxTime: number = 1000 * 5;
        ...
        public play(): void {
            ...
            if (this.active && this.active instanceof Display3dMovie) {
                ...
                $movie3d.play(this.skillVo.action, this.actionEnd?1:2, false,null,()=>{
                    if(this.actionCompleteFun){
                        this.actionCompleteFun();
                    }
                });
            }
        ...
        private getKeyTarget(): void {
            ...
            for (var i: number = this.targetFlag; i < this.keyAry.length;) {
        ...
        private getSound(): void {
            ...
            if (this.skillVo.sound.frame < this.time) {
                AudioMgr.playSound(Scene_data.soundPath+this.skillVo.sound.url);
                this.soundPlay = true;
            }

        }

        public configFixEffect($active: Object3D, $actionCompleteFun: Function = null,$completeFun: Function = null, $posObj: Array<Vector3D> = null): void {
            this.active = $active;
