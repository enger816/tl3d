...
import { DynamicConstItem } from "../material/DynamicConstItem";
import { TexItem } from "../material/TexItem";
import { DynamicTexItem } from "../material/DynamicTexItem";
...
export class Display3DParticle extends Object3D {
    ...
    public updateMatrix(): void {
        ...
        this.modelMatrix.appendTranslation(this.bindVecter3d.x * SceneManager.scaleWorld.x
                                    , this.bindVecter3d.y * SceneManager.scaleWorld.y
                                    , this.bindVecter3d.z * SceneManager.scaleWorld.z);
