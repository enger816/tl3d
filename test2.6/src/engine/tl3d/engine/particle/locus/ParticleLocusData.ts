...
import { Display3DLocusPartilce } from "./Display3DLocusPartilce";
...
import { Display3DLocusShader } from "./Display3DLocusShader";
...
export class ParticleLocusData extends ParticleData {
    ...
    public setAllByteInfo($byte: Pan3dByteArray): void {
        ...
        let vertexDeclaration: VertexDeclaration = new VertexDeclaration(stride, eles)
        ...
        var indexBuffer: IndexBuffer3D = new IndexBuffer3D(this.objData.indexFormat, indices.length, WebGLRenderingContext.STATIC_DRAW, false);
    ...
    public regShader(): void {
        ...
        this.materialParam.shader = ProgramManager.getInstance().getMaterialProgram(Display3DLocusShader.Display3D_Locus_Shader,
