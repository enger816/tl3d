...
import {CharAction} from "../../../pan3d/baseprite/CharAction"
        ...
        public makeData(): void {
            if (this._data) {
                ...
                for (var i: number = 0; i < this._buffTitleMesh.buffarr.length; i++) {
                    ...
                    UiDraw.cxtDrawImg(ctx, "TYPE" + picId, new Rectangle(30*i, 0, 32, 32), UIData.publicUi);  //逐个绘制BUFF图片，取公共图片。对应可自行设置参数
                }
    ...
    export class BuffThreeModel {
        ...
        constructor($scene: layapan.LayaOverride2dSceneManager) {
            this._scene = $scene
            this._buffDis2DUI = new Dis2DUIContianerPanel(BuffTitleUiVo, new  Rectangle(0, 0, 256, 32), 10);
    ...
    export class BuffThreePanel extends Laya.Sprite {
        ...
        private onStartDrag(e: Event): void {
            ...
            */
            ...
            this.uiLayaSceneChar.moveTopos(new Vector2D(this.mouseX - this.ape.x, this.mouseY - this.ape.y));  //坐标
            ...
            this.layaSceneLevel.scene.playLyf("model/qigan.txt", new Vector3D($tx, 0, $tz), random(360));
            */
        }
