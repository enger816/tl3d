...
import { BaseRes } from "./res/BaseRes";
...
export class MeshDataManager extends ResGC {
    ...
    private roleResCom($roleRes: RoleRes, $fun: Function): void {
        ...
        var funs:Function[] = this._loadDic[url];
...
/*             } else {
    ...
    public readMesh2OneBuffer(byte: Pan3dByteArray, meshData: MeshData): void {
		...
		var indexBuffer: IndexBuffer3D = new IndexBuffer3D(meshData.indexFormat, indices.length, WebGLRenderingContext.STATIC_DRAW, false);
