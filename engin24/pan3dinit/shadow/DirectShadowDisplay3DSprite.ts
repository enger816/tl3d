...
import { Shader3D } from "../../pan3d/engine/program/Shader3D";
import { Display3DSprite } from "../../pan3d/engine/display3D/Display3DSprite";
...
import { TextureRes } from "../../pan3d/engine/material/TextureRes";
import { TextureManager } from "../../pan3d/engine/material/TextureManager";
import { GroupDataManager } from "../../pan3d/engine/utils/GroupDataManager";
import { GroupRes, GroupItem } from "../../pan3d/engine/utils/res/GroupRes";
...
export class DirectShadowDisplay3DSprite extends Display3DSprite {
    ...
    protected drawTemp($dis: Display3DSprite): void {
        ...
        if (!(<OverrideSceneManager>this._scene).fbo || !ShadowModel.shadowViewMatx3D) {
            return;
        }
        ...
        if ($objdata && $objdata.indexBuffer && this._uvTextureRes) {
            ...
            Scene_data.context3D.setVc3fv($shader, "sunDirect", (<OverrideSceneManager>this._scene).light.sunDirect);
            Scene_data.context3D.setVc3fv($shader, "sunColor", (<OverrideSceneManager>this._scene).light.sunColor);
            Scene_data.context3D.setVc3fv($shader, "ambientColor", (<OverrideSceneManager>this._scene).light.ambientColor);
            ...
            Scene_data.context3D.setRenderTexture($shader, "fs1", (<OverrideSceneManager>this._scene).fbo.texture, 1);
