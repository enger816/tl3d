...
(function (level) {
    ...
    var SelectLevelPanel = /** @class */ (function (_super) {
        ...
        SelectLevelPanel.prototype.loadConfigCom = function () {
            ...
            this.e_bg = this.addChild(this._bottomRender.getComponent("e_bg"));
            this.e_bg.addEventListener(InteractiveEvent.Down, this.mouseDown, this);
            this.e_bg.addEventListener(InteractiveEvent.Up, this.baseButUp, this);
            this.e_bg.width = 540 * Pan3d.UIData.Scale;
            this.e_bg.height = 960 * Pan3d.UIData.Scale;
            this.e_bg.left = 0;
            this.e_bg.top = 0;
            var $e_tittle_txt = this.addChild(this._topRender.getComponent("e_tittle_txt"));
            this.addChild(this._bottomRender.getComponent("e_window_bg"));
            this.addChild(this._midRender.getComponent("e_tittle_bg"));
            this.addChild(this._midRender.getComponent("e_level_list_bg"));
        ...
        SelectLevelPanel.prototype.showLevelAll = function () {
            ...
            for (var i = 0; i < this.pageTatolNum24; i++) {
                ...
                Pan3d.ArtFont.getInstance().writeFontToCtxCenten($ctx, String($level), "NUM41", 25, 0, 6);
    ...
    level.SelectLevelPanel = SelectLevelPanel;
})(level || (level = {}));
