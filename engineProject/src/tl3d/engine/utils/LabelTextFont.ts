namespace tl3d {
    ...
    export class TextRegExp {
         ...
         * @param  
         */
        static wrapText($ctx: CanvasRenderingContext2D, text: string, baseColor: string, x: number = 0, y: number = 0,
         ...
         * @param  
         */
        static wrapTextVertical($ctx: CanvasRenderingContext2D, text: string, baseColor: string, x: number = 0, y: number = 0,
         ...
         * @param  
         */
        static drawText($ctx: CanvasRenderingContext2D, text: string, baseColor: string,
    ...
    export  class LabelTextFont {
        ...
        */
        static writeSingleLabel($uiAtlas: UIAtlas, $key: string, $str: string, fontsize: number = 12, $align: string = TextAlign.CENTER,
        ...
        */
        static writeTextLabel($uiAtlas: UIAtlas, $key: string, $str: string, fontsize: number = 12, $align: CanvasTextAlign = "center", $maxWidth: number = 500,
         ...
         * 
         */
        static writeSingleLabelToCtx($ctx: CanvasRenderingContext2D, $str: string, fontsize: number = 12, $tx: number = 0, $ty: number = 0,
         ...
         * 
         */
        static writeSingleLabelToCtxByVertical($ctx: CanvasRenderingContext2D, $str: string, fontsize: number = 12, $tx: number = 0, $ty: number = 0,
         ...
         * $tx 为对齐点的坐标
         */
        static writeSingleLabelToCtxSetAnchor($ctx: CanvasRenderingContext2D, $str: string, fontsize: number = 12, $tx: number = 0, $ty: number = 0,
            $align: string = TextAlign.CENTER, $baseColor: string = "#ffffff", $filterColor: string = "", $bolder: boolean = true): number {
         ...
         */
        static writeText($uiAtlas: UIAtlas, $key: string,
            $x: number, $y: number,
            $str: string, fontsize: number, fontColor: string, $maxWidth: number = 0, bolder: boolean = false, $textAlign: CanvasTextAlign = "left"): Array<number> {
         ...
         */
        static writeTextAutoCenterByAnchor($uiAtlas: UIAtlas, $key: string,
        ...
        */
        static writeTextAutoVerticalCenter($uiAtlas: UIAtlas, $key: string,
        ...
        */
        static writeTextAutoCenter($uiAtlas: UIAtlas, $key: string,
