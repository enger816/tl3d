    ...
    export class SceneManager {
        ...
        */
        ...
        public removeSpriteDisplay($display: Display3DSprite): void {
            ...
            {
                console.log('要移除的武器===='+$display.bindSocket);
                console.log('移除武器失败,容器中没有此武器=======this._displaySpriteList',this._displaySpriteList.length) ;
            }
            $display.removeStage();
        }
        /**
        ...
        protected updateMovieDisplay(): void {
            ...
            // console.log("场景中角色", this._displayRoleList.length)
