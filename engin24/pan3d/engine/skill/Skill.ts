...
import {SkillType} from "./vo/SkillVo"
import {SkillFixEffect} from "./key/SkillFixEffect"
import {SkillTrajectoryTargetKeyVo} from "./vo/SkillKeyVo"
import {SkillMulTrajectory} from "./key/SkillMulTrajectory"
import {SkillManager} from "./SkillManager"
import {ShockUtil} from "./SkillManager"
        ...
        private getShockTarget(): void {
            ...
            for (var i: number = this.targetShockFlag; i < this.skillVo.shockAry.length; i++) {
                if (this.skillVo.shockAry[i].time < this.time) {
                    ...
                    console.log("震动：",i,this.skillVo.shockAry[i].time,this.skillVo.shockAry);
