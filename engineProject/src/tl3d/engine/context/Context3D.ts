namespace tl3d {
    export class Context3D {
        ...
        public _contextSetTest: ContextSetTest;
          private nullBuff:WebGLBuffer; //创建一个空ＢＵＦＦ。玄狐
        public init($caves: HTMLCanvasElement): void {
            //this.renderContext = $caves.getContext("experimental-webgl");

            var gl: any = $caves.getContext('webgl', { stencil: true, alpha: true, depth: true, antialias: true })
    ...
    export class FBO {
        static fw: number = 512;
        static fh: number = 512;
