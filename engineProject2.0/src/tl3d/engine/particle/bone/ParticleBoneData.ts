...
import { Display3DBonePartilce, Display3DBoneShader } from "./Display3DBonePartilce";
...
export class ParticleBoneData extends ParticleData {
    ...
    public regShader(): void {
        this.materialParam.shader = ProgramManager.getInstance().getMaterialProgram(Display3DBoneShader.Display3DBoneShader,
