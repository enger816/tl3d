import { PlanarShadowShader, AnimPlanarShadowShader } from './../../../tl3dinit/shadow/PlanarShadowShader';
import { IBind } from "./interfaces/IBind";
import { Display3DSprite } from "./Display3DSprite";
import { SkinMesh } from "../vo/skinanim/SkinMesh";
import { RoleRes } from "../utils/res/RoleRes";
import { CapsuleVo } from "../vo/collistion/CapsuleVo";
import { Shadow } from "../utils/shadow/Shadow";
import { Vector2D } from "../math/Vector2D";
import { MeshDataManager } from "../utils/MeshDataManager";
import { BaseEvent } from "../events/BaseEvent";
import { CombineParticle } from "../particle/CombineParticle";
import { MeshData, BindParticle } from "../base/MeshData";
import { ParticleManager } from "../particle/ParticleManager";
import { Scene_data } from "../context/Scene_data";
import { Material } from "../material/Material";
import { ShadowManager } from "../utils/shadow/ShadowManager";
import { SceneManager } from "../scene/SceneManager";
import { GroupRes, GroupItem } from "../utils/res/GroupRes";
import { GroupDataManager } from "../utils/GroupDataManager";
import { Vector3D } from "../math/Vector3D";
import { BaseRes } from "../utils/res/BaseRes";
import { Matrix3D } from "../math/Matrix3D";
import { BoneSocketData } from "../vo/skinanim/BoneSocketData";
import { AnimData, DualQuatFloat32Array } from "../vo/skinanim/AnimData";
import { AnimManager } from "../utils/AnimManager";
import { LightProbeManager } from "../utils/LightProbeManager";
import { LineDisplaySprite } from "../scene/grldLevel/LineDisplaySprite";
...
export class Display3dMovie extends Display3DSprite implements IBind {
    ...
    /** 待机动作 */
    protected _defaultAction: string = "idle";
    ...
    */
    ...
    public getSocketByScale(socketName: string, resultMatrix: Matrix3D): void {
    ...
    public  isPauseAnim :boolean = false;

    public get pauseAnim():boolean{
        return this.isPauseAnim ;
    }
    
    public set pauseAnim(v : boolean){
        this.isPauseAnim = v;
    }

    public get animNormalizerTime(): number
    {
    ...
    protected curActionTime:number = 0;
...
/*         Scene_data.context3D.clearVa(2);
    ...
    public static animPlanarShadowShader : AnimPlanarShadowShader;

    private makeAnimPlanarShadowShader (): AnimPlanarShadowShader
    {
    ...
    public isEnableAnimPlanarShadow : boolean = false;
    public set enableAnimPlaranShadow ( v : boolean ){
        this.isEnableAnimPlanarShadow = v;
    }
 

    //Plannar shadow pass*/
    public renderPlanarShadow($mesh:MeshData):void
    {
    ...
    public isRenderAnimPlanarShadow():boolean{
    ...
    public renderAnimPlanarShadow($mesh : MeshData):void  
    {
    ...
    public renderAnimPlanarShadowAll():void{
