 ...
 */
export class LQuaternion implements IClone {
	/**@internal */
	...
	/**默认矩阵,禁止修改*/
	static DEFAULT: LQuaternion =/*[STATIC SAFE]*/ new LQuaternion();
	/**无效矩阵,禁止修改*/
	static NAN: LQuaternion = new LQuaternion(NaN, NaN, NaN, NaN);
...
/* 	static createFromMatrix4x4(mat: Matrix4x4, out: LQuaternion): void {
	 ...
	 */
	clone(): any {
		var dest: LQuaternion = new LQuaternion();
		this.cloneTo(dest);
		return dest;
	}
