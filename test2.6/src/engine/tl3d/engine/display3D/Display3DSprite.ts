import { PlanarShadowShader } from './../../../tl3dinit/shadow/PlanarShadowShader';
...
import { ObjDataManager } from "../utils/ObjDataManager";
import { TextureManager } from "../material/TextureManager";
import { MaterialManager } from "../material/MaterialManager";
import { MaterialShader } from "../program/MaterialShader";
    ...
    public updateBind(): void {
        if (this.bindTarget) {
            ...
            this.bindTarget.getSocket(this.bindSocket, this.bindMatrix);
				...
				this.posMatrix.appendTranslation(this._x * SceneManager.scaleWorld.x
					,this._y * SceneManager.scaleWorld.y
					,this._z * SceneManager.scaleWorld.z)
