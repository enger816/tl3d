...
(function (uiview) {
    ...
    var TopThreeView = /** @class */ (function (_super) {
        __extends(TopThreeView, _super);
        function TopThreeView() {
        ...
        TopThreeView.prototype.butClik = function (evt) {
            UIManager.getInstance().removeUIContainer(this);
            console.log(evt.target);
        };
        TopThreeView.prototype.loadConfigCom = function () {
        ...
        TopThreeView.prototype.setData = function () {
            for (var i = 0; i < 3; i++) {
                ...
                ArtFont.getInstance().writeFontToSkinName(this._bottomRender.uiAtlas, $leveUi.skinName, String(i + 1), "NUM42", TextAlign.CENTER);
                ArtFont.getInstance().writeFontToSkinName(this._bottomRender.uiAtlas, $tatolUi.skinName, String(random(1000)), "NUM17", TextAlign.CENTER, 3);
                this._bottomRender.uiAtlas.upDataPicToTexture("touxiang.jpg", $picUi.skinName);
            }
        };
        return TopThreeView;
    }(UIConatiner));
    uiview.TopThreeView = TopThreeView;
})(uiview || (uiview = {}));
//# sourceMappingURL=TopThreeView.js.map