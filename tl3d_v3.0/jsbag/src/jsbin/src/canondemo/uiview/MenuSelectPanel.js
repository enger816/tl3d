...
(function (menuselect) {
        ...
        MenuSelectPanel.prototype.butClik = function (evt) {
            switch (evt.target) {
                ...
                case this.m_select_level_txt:
                    Pan3d.ModuleEventManager.dispatchEvent(new uiview.TopUiViewEvent(uiview.TopUiViewEvent.SHOW_SELECT_LEVEL_PANEL));
                    break;
                case this.m_select_sys_txt:
                    Pan3d.ModuleEventManager.dispatchEvent(new uiview.TopUiViewEvent(uiview.TopUiViewEvent.SHOW_SETUP_WIN_PANEL));
                    break;
    ...
    menuselect.MenuSelectPanel = MenuSelectPanel;
