...
class Sanguo3dScenePanel extends Laya.Sprite {
    constructor() {
        ...
        this.addBaseRole("wujiang_0001", new Vector3D(-70, 0, -80), 90);
        this.addBaseRole("wujiang_0002", new Vector3D(-70, 0, -30), 90);
        this.addBaseRole("wujiang_0003", new Vector3D(-70, 0, +30), 90);
        this.addBaseRole("wujiang_0014", new Vector3D(-70, 0, +80), 90);


        this.addBaseRole("npc_0003", new Vector3D(+70, 0, -80), -90);
        this.addBaseRole("npc_0004", new Vector3D(+70, 0, -30), -90);
        this.addBaseRole("npc_0005", new Vector3D(+70, 0, +30), -90);
        this.addBaseRole("npc_0006", new Vector3D(+70, 0, +80),- 90);
   ...
   // private uiLayaSceneChar: layapan.LayaSceneChar
    ...
    private charPlaySkill($char: layapan.LayaSceneChar, $skillfile: string, $effectName: string): void {
        ...
        this.ape.showJumpText(this.layaSceneLevel.scene, new Vector3D($char.px, $char.py, $char.pz))
    }
    ...
    private addBaseRole($str: string = "ms_0001", $pos: Vector3D=null, $rotation: number=0): void {
