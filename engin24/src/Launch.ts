...
class Launch {
    ...
    private addLaya3dScene(): void {
        ...
        // Laya.stage.addChild(new SkillDandaoPanel); //弹道
        // Laya.stage.addChild(new skillDingdianUiPanel); //定点技能

        //  Laya.stage.addChild(new SelectChar3dPanel); //BUFF
    ...
    private loadBaseUiArt(): void {
        TableData.getInstance().loadGameData("data/tb.txt", () => {
            ...
            $baseUiList.push({ xmlurl: "ui/textlist/textlist.xml", picurl: "ui/textlist/textlist.png", name: UIData.textlist });
            $baseUiList.push({ xmlurl: "ui/public/public.xml", picurl: "ui/public/public.png", name: UIData.publicUi });
