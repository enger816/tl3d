...
import { Display3DFacetParticle } from "./facet/Display3DFacetParticle";
import { Display3DBallPartilce } from "./ball/Display3DBallPartilce";
import { Display3DLocusPartilce } from "./locus/Display3DLocusPartilce";
import { Display3DLocusBallPartilce } from "./locusball/Display3DLocusBallPartilce";
import { Display3DModelObjParticle } from "./model/Display3DModelObjParticle";
import { Display3DModelPartilce } from "./model/Display3DModelPartilce";
import { Display3dModelAnimParticle } from "./model/Display3dModelAnimParticle";
import { Display3DFollowPartilce } from "./follow/Display3DFollowPartilce";
...
export class CombineParticle extends EventDispatcher {
  ...
  /*   public setData(ary: Array<any>): void {
    ...
    public updateItem(idx: number): void {
        ...
        let particle:Display3DParticle = this._displayAry[idx];
        if(!particle)
        {
