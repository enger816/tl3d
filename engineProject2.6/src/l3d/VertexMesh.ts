import { VertexDeclaration } from "./VertexDeclaration";import { VertexElement } from "./VertexElement";import { VertexElementFormat } from "./VertexElementFormat";
...
export class VertexMesh {
	...
	static MESH_COLOR0: number = 6;

	static MESH_TEXTURECOORDINATE0: number = 1;

	static MESH_NORMAL0: number = 4;
	static MESH_TANGENT0: number = 5;

	static MESH_BLENDINDICES0: number = 2;
	static MESH_BLENDWEIGHT0: number = 3;
